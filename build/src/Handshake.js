...
exports.HandshakeAsServer = exports.HandshakeAsClient = void 0;
...
function clientSharedSecret_ab(clientEphemeralSk, serverEphemeralPk) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_scalarmult(clientEphemeralSk, serverEphemeralPk));
}
function serverSharedSecret_ab(serverEphemeralSk, clientEphemeralPk) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_scalarmult(serverEphemeralSk, clientEphemeralPk));
}
function clientSharedSecret_aB(clientEphemeralPk, serverLongtermPk) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_scalarmult(clientEphemeralPk, libsodium_wrappers_1.default.crypto_sign_ed25519_pk_to_curve25519(serverLongtermPk)));
}
function serverSharedSecret_aB(serverLongtermSk, clientEphemeralPk) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_scalarmult(libsodium_wrappers_1.default.crypto_sign_ed25519_sk_to_curve25519(serverLongtermSk), clientEphemeralPk));
}
function clientSharedSecret_Ab(clientLongtermSk, serverEphemeralPk) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_scalarmult(libsodium_wrappers_1.default.crypto_sign_ed25519_sk_to_curve25519(clientLongtermSk), serverEphemeralPk));
}
function serverSharedSecret_Ab(serverEphemeralSk, clientLongtermPk) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_scalarmult(serverEphemeralSk, libsodium_wrappers_1.default.crypto_sign_ed25519_pk_to_curve25519(clientLongtermPk)));
}
function signDetached(msg, secretKey) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_sign_detached(msg, secretKey));
}
...
function secretBox(msg, nonce, key) {
    return Buffer.from(libsodium_wrappers_1.default.crypto_secretbox_easy(msg, nonce, key));
}
...
exports.HandshakeAsClient = HandshakeAsClient;
/**
...
exports.HandshakeAsServer = HandshakeAsServer;
